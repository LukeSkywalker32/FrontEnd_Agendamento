...
export function NovoAgendamento() {
  ...
  // Carregar janelas de tempo quando a empresa for selecionada
  useEffect(() => {
    ...
    <Page>
      ...
      <FormCard>
        <form onSubmit={handleSubmit}>
          ...
          <Actions>
            <Button variant="secondary" type="button" onClick={() => navigate("/carrier/meus")}>
              Cancelar
            </Button>
