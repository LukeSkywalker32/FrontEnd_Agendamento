                  ...
                  <Td>
                    <ActionGroup>
                      {user.isActive ? (
                        ...
                        >
                          {processingUserId === user._id ? "Desativando..." : "Desativar"}
                        </Button>
                      ) : (
      ...
      {deleteTarget && (
        <ModalOverlay onClick={() => !deleting && setDeleteTarget(null)}>
          <ModalCard onClick={e => e.stopPropagation()}>
            ...
            <ModalDesc>
              Você está prestes a excluir <strong>"{deleteTarget.name}"</strong>. Esta ação não pode
              ser desfeita e todos os dados do usuário serão removidos do sistema.
            </ModalDesc>
            <ModalActions>
